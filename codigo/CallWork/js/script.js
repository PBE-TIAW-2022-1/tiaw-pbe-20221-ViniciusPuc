...
let btnProposta = document.getElementById('btnProposta');
...
btnProposta.addEventListener("click", ()=>{
    ...
    let proposta = document.getElementById('propostaArea').value;

    if (valor != '' && proposta != ''){
        window.location = `https://wa.me/${telefone}?text=Valor:%20${valor}%0DProposta:%20${proposta}`;
    }else{
